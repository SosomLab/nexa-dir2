...
1. **실기 QA 잔여분 소화** — 사용자 QA가 병목. 새 기능보다 우선. 최신 대기분 = **X-42 가상 파일 붙여넣기** + **X-43 빈 폴더 글리프 억제**(둘 다 08-23 구현·미배포) + X-40 클라우드 실검증. **X-44 감시 보완 6건**("간혹 F5" 전수 조사 결과 — [TODO](docs/TODO.md) §7)은 착수 여부 사용자 결정 대기.
...
3. **winget 0.16.0 PR 2건 심사 중**(08-11 제출·우리 측 조치 불요·상태만 추적): [#415214](https://github.com/microsoft/winget-pkgs/pull/415214) Portable · [#415215](https://github.com/microsoft/winget-pkgs/pull/415215) 설치형(0.8.1 등록 이후 첫 버전 업데이트). 카탈로그는 아직 Portable 0.13.0 · 설치형 0.8.1. **OPEN인 동안 winget은 제출 제외**(위 규칙).
