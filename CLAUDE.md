...
1. **실기 QA 잔여분 소화** — 사용자 QA가 병목. 새 기능보다 우선. 최신 대기분 = **X-42 가상 파일 1·2차**(RDP 붙여넣기+워커·undo·DnD·클라우드) + **X-43 빈 폴더 글리프+β** + **X-44 간헐 무갱신 1·2차**(활성화=갱신·뷰포트 접힌 폴더 감시 — 실측으로 앱 체인 정상 확인, 클라우드 케이스는 동기화 도착 기준 관찰) + **X-45 항상 맨 위에**(전부 08-23 구현·미배포·재시작 반영) + X-40 클라우드 실검증.
