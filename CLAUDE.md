...
현 단계: **포스트 M5 — UX 고도화 + 배포 채널 정착**. M0(`0.1.0`)~M5(`0.6.0`) 완료, 최신 릴리스 **`0.18.0`**(08-24 — **X-46 압축 파일 미리보기**[그리드 창·암호 입력·플러그인 ABI v2 — [28](docs/28-archive-preview.md)] + **미리보기 플러그인 2종 동봉 배포**[markdown.wasm·archive.wasm — 포터블 zip·설치본·플러그인 zip. [21 §5-2](docs/21-distribution.md)]. **winget 0.18.0 PR 2건 병합 완료**[#423258·#423259 — 제출 40분 만·두 채널 최신과 동기]·Chocolatey 2종은 0.8.1 모더레이션에 잠긴 채라 **채널 제출 규칙으로 push 제외** — [21 §7·§8](docs/21-distribution.md)).
...
3. **winget 두 채널 `0.18.0` 동기 완료**(08-24 — 제출 규칙 2회째): [#423258](https://github.com/microsoft/winget-pkgs/pull/423258) Portable · [#423259](https://github.com/microsoft/winget-pkgs/pull/423259) 설치형 **둘 다 병합**(제출 약 40분 만 — 역대 최단). **winget 쪽 대기 0건** → 다음 릴리스도 규칙상 제출 대상.
