...
3. **winget 0.18.0 PR 2건 심사 중**(08-24 제출 — 제출 규칙 2회째·조치 불요·상태 추적만): [#423258](https://github.com/microsoft/winget-pkgs/pull/423258) Portable · [#423259](https://github.com/microsoft/winget-pkgs/pull/423259) 설치형. 직전 0.17.0 2건은 **제출 ~2시간 만에 병합**(08-23).
