...
use windows::Win32::UI::WindowsAndMessaging::{
    ...
    GetParent, GetWindowLongPtrW, MoveWindow, RegisterClassW, SendMessageW, SetWindowLongPtrW,
    SetWindowPos, ES_AUTOHSCROLL, GWLP_USERDATA, GWLP_WNDPROC, HMENU, HWND_TOPMOST, IDC_ARROW,
    SWP_NOACTIVATE, SWP_SHOWWINDOW, WINDOW_EX_STYLE, WINDOW_STYLE, WM_CHAR, WM_COMMAND, WM_CREATE,
    WM_CTLCOLOREDIT, WM_DESTROY, WM_DRAWITEM, WM_GETTEXT, WM_GETTEXTLENGTH, WM_KEYDOWN,
    WM_KILLFOCUS, WM_LBUTTONDOWN, WM_LBUTTONUP, WM_MOUSEMOVE, WM_PAINT, WM_SETFOCUS, WM_SETFONT,
    WM_SETTEXT, WM_SIZE, WNDCLASSW, WS_CHILD, WS_EX_NOACTIVATE, WS_EX_TOOLWINDOW, WS_EX_TOPMOST,
