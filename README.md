...
- 단계: **포스트 M5 — UX 고도화·배포 채널 정착**. M0~M5 완료(`0.1.0`~`0.6.0`), 최신 릴리스 **`0.16.0`**(2026-08-11 — 외부·클라우드 변경 자동 갱신·도구 모음 크기 조정). 상세 → [docs/STATUS.md](docs/STATUS.md).
- 실측(`0.16.0`): exe **3.66MB** ≤10 · 임포트 **OS 인박스 21종만** · 유휴 RSS 16.86MB ≤30 · 100k 첫 렌더 115ms.
