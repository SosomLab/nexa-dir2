...
- 단계: **포스트 M5 — UX 고도화·배포 채널 정착**. M0~M5 완료(`0.1.0`~`0.6.0`), 최신 릴리스 **`0.17.0`**(2026-08-23 — RDP/Outlook 가상 파일 붙여넣기·클라우드 즉시 갱신(셸 통지)·빈 폴더 글리프·항상 맨 위). 상세 → [docs/STATUS.md](docs/STATUS.md).
- 실측(`0.17.0`): exe **3.71MB** ≤10 · 임포트 **OS 인박스 21종만** · 유휴 RSS 16.86MB ≤30 · 100k 첫 렌더 115ms.
