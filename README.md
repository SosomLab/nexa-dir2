...
- 단계: **포스트 M5 — UX 고도화·배포 채널 정착**. M0~M5 완료(`0.1.0`~`0.6.0`), 최신 릴리스 **`0.19.0`**(2026-09-04 — 설정 창 스크롤 재구축·글꼴 폴백 체인·파일 목록 오버레이 스크롤바. 직전 `0.18.1` 2026-08-24 — 압축 파일 미리보기·플러그인 동봉 배포[0.18.0] + 설치형 VERSIONINFO 보강[0.18.1]). 상세 → [docs/STATUS.md](docs/STATUS.md).
