...
| **포스트 M5** | UX 고도화·배포 채널 정착 — 툴바 SVG·순서 편집 3종 창·컬럼 드래그/auto-fit·다크모드 아이콘·위키 · X-25~32(탭 UX·전송 진행 UX·일본어 언어팩·클립보드/DnD UX) · X-2 **플러그인 wasmi 전환**([ADR-0005](25-adr-0005-wasm-plugins.md)) · X-34 새로 만들기 · X-35 삭제 잠금 처리 · **안정성 감사 7건** · ZIP 자산/SHA256SUMS · **X-36/X-37 클라우드**(Link 탐지 + Connect OAuth 직접 연결 — [ADR-0006](27-adr-0006-cloud-oauth.md)) | B2 **3.44MB**·B3 통과(클라우드 +4 DLL) | ✅ `0.7.0`·`0.8.0`·`0.8.1`(choco/winget 등록)·`0.9.0`·`0.10.0`·`0.11.0`·`0.12.0`·**`0.13.0`**(08-02 — GitHub Release + winget Portable. choco push는 스위치 꺼짐) |
