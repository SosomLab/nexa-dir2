...
| **포스트 M5** | UX 고도화·배포 채널 정착 — 툴바 SVG·순서 편집 3종 창·컬럼 드래그/auto-fit·다크모드 아이콘·위키 · X-25~32(탭 UX·전송 진행 UX·일본어 언어팩·클립보드/DnD UX) · X-2 **플러그인 wasmi 전환**([ADR-0005](25-adr-0005-wasm-plugins.md)) · X-34 새로 만들기 · X-35 삭제 잠금 처리 · **안정성 감사 7건** · ZIP 자산/SHA256SUMS · **X-36/X-37 클라우드**(Link 탐지 + Connect OAuth 직접 연결 — [ADR-0006](27-adr-0006-cloud-oauth.md)) | B2 **3.66MB**(0.16.0 실측·10진 MB)·B3 통과 21종(클라우드 +4 DLL) | ✅ `0.7.0`~`0.14.0` · **`0.15.0`**(08-11 — X-40 외부·클라우드 변경 **자동 갱신**[활성화 갱신+프로브 폴링+디바운스 상한]) · **`0.16.0`**(08-11 — X-41 바 크기 확정: 도구 모음 28·퀵 런처 24). **winget 2채널 모두 `0.16.0` 라이브**([#415214](https://github.com/microsoft/winget-pkgs/pull/415214) 08-11·[#415215](https://github.com/microsoft/winget-pkgs/pull/415215) 08-14 병합 — 최신 릴리스와 완전 동기, 08-23 실측) · choco push는 스위치 꺼짐(0.8.1 모더레이션 대기 — 이중 큐 회피) |
