...
| **포스트 M5** | UX 고도화 — 툴바 SVG·순서 편집 3종 창·컬럼 드래그/auto-fit·하단 도크 버튼·다크모드 아이콘·exe 리소스 아이콘·배포명 "Nexa Dir"·위키 · 07-20~22 X-25~32(탭 UX·전송 진행 UX·일본어 언어팩·클립보드/DnD UX) | B1 0.27(트림)·B2 1.43·B3 17종 | ✅ `0.7.0`·`0.8.0`·`0.8.1`(choco/winget 등록)·`0.9.0`·`0.10.0`(GitHub 전용 — choco push 스위치 꺼짐) |
