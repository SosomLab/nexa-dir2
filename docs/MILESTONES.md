...
| **포스트 M5** | UX 고도화·배포 채널 정착 — 툴바 SVG·순서 편집 3종 창·컬럼 드래그/auto-fit·다크모드 아이콘·위키 · X-25~32(탭 UX·전송 진행 UX·일본어 언어팩·클립보드/DnD UX) · X-2 **플러그인 wasmi 전환**([ADR-0005](25-adr-0005-wasm-plugins.md)) · X-34 새로 만들기 · X-35 삭제 잠금 처리 · **안정성 감사 7건** · ZIP 자산/SHA256SUMS · **X-36/X-37 클라우드**(Link 탐지 + Connect OAuth 직접 연결 — [ADR-0006](27-adr-0006-cloud-oauth.md)) | B2 **3.71MB**(0.17.0 실측·10진 MB)·B3 통과 21종(클라우드 +4 DLL) | ✅ `0.7.0`~`0.14.0` · **`0.15.0`**(08-11 — X-40 외부·클라우드 변경 **자동 갱신**[활성화 갱신+프로브 폴링+디바운스 상한]) · **`0.16.0`**(08-11 — X-41 바 크기 확정: 도구 모음 28·퀵 런처 24) · **`0.17.0`**(08-23 — X-42 **가상 파일 붙여넣기**[RDP·Outlook·zip — 워커·undo·DnD·클라우드]·X-43 빈 폴더 글리프·X-44 **클라우드 즉시 갱신**[셸 통지 이벤트 1선+보험 스윕]·X-45 항상 맨 위). **winget 2채널 `0.16.0` 라이브**(08-11·08-14 병합) + **`0.17.0` PR 2건 제출**([#422930](https://github.com/microsoft/winget-pkgs/pull/422930)·[#422931](https://github.com/microsoft/winget-pkgs/pull/422931) — 제출 규칙 첫 적용) · choco push는 당시 스위치 꺼짐(0.8.1 모더레이션 대기 — 이중 큐 회피. **09-02 승인·재개** → `0.18.1` 제출) |
