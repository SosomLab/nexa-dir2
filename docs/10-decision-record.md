...
| `wasmi` 1.1.0 | 플러그인 런타임(ADR-0005 — `data\plugins\*.wasm` 로드·실행, fuel/메모리 격리. `wat`은 dev-dep 테스트 전용) | MIT/Apache-2.0 | **B2 실측 +1.68MB**(starlark 제거 후 1.50→3.18MB — 게이트 ≤10·여유 6.8) | 2026-07-26 |
