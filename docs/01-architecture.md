...
- **텍스트**: 1차(M0 스파이크) GDI `ExtTextOutW` → 2차(M1) **DirectWrite GDI interop**(`IDWriteBitmapRenderTarget`) — ClearType 품질 + GPU 스왑체인 없음. 선택은 [ADR-0002](07-adr-0002-rendering.md)(M1 초 확정).
