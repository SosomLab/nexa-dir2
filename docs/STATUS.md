...
> **갱신: 2026-07-13 (KST)** — **M3-5 클립보드 상호운용·OLE DnD 완료**: **OS 클립보드 단일
> 출처**(CF_HDROP·Preferred DropEffect — 내부 클립보드 제거, 탐색기↔앱 Ctrl+C/X/V·잘라내기
> 1회성·실 왕복 테스트) · **DnD 수신**(IDropTarget — Ctrl 복사/Shift 이동/기본 볼륨별·자기/하위
> 금지·최적화 이동 NONE 반환=소스 삭제 경쟁 차단) · **발신**(SHCreateDataObject+DoDragDrop —
> 행 누름+임계 이동·원본 미삭제 안전 방향). B3 무변·DnD 실기 QA 대기.
> 다음: **M3-6 watcher**(무간섭 갱신 — 선택·캐럿·스크롤 보존) → M3 마감.
