...
> 테스트 166 green·clippy 0. 실기 QA(런처 아이콘·리네임 파이프라인·설정 트리·
> 스크린리더) 대기. 다음: X-11 패리티 갭 건별 · X-2 Starlark · X-3 터미널 설정 ·
> X-10 잔여(②~⑤).
...
| B2 exe 크기 | ≤10MB | **1.01MB** (regex-lite +0.11MB 원장 등재 — 일괄 이름변경·런처·설정 트리·언어팩 포함) | 07-15 실기 |
...
3. 백로그: **X-11 원본 패리티 갭 건별**([19](19-parity-gap.md) G-1~14) · X-2 Starlark 플러그인 · X-3 터미널 설정 잔여 · X-10 설정 창 심화 잔여(~~①~~ ✅ ②~⑤) · X-1 Apps 키 QA.
