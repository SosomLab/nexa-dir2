...
> 다음: **M3-6 watcher**(자동 갱신 — 무간섭 재로드 기반 마련됨) → M3 마감.
...
- **M3** 파일 조작 🚧 — M3-1~5 ✅(전송 엔진·삭제/이름변경/새로 만들기·Undo/Redo+휴지통 복원·셸 컨텍스트 메뉴·OS 클립보드/OLE DnD) · watcher ☐.
- M4 패널 · M5 마감 — ☐.
...
1. ~~M0~~ ✅ `0.1.0` · ~~M1~~ ✅ `0.2.0` · ~~M2~~ ✅ `0.3.0` · ~~M3-1~5~~ ✅ (07-13).
2. **M3-6 watcher**(P1, 중) — 무간섭 갱신(선택·캐럿·스크롤 보존, 원본 NAV-UPFOCUS·docs/33 B-12w) → M3 마감.
