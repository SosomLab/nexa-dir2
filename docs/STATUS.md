...
> **갱신: 2026-09-04 (KST)** — **설정 창 본문 스크롤 재구축 + 글꼴 폴백 체인**(사용자 QA·요청 — 상세
...
> - **하루 마감**: 코드 6·문서 5 커밋 → **main push**(사용자 지시) · 테스트 321 green·clippy 0·비Windows
>   검사 green · 채널 무변동(choco `0.18.1` 검수 중·winget `0.18.1` 라이브) · **미배포** — 실기 QA 뒤 릴리스.
>
> ---
>
