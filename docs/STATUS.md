...
2. **X-44 감시 파이프라인 보완 6건 — 착수 여부 사용자 결정 대기**(08-23 전수 조사 — "간혹 F5" 유력 원인 순: 탭 전환 재열거 · 프로브 기준선 즉시 수립 · fsprobe 서명 강화 · WM_DEVICECHANGE · 펼침 폴더 라운드로빈 · 소실 폴더 폴백. [TODO](TODO.md) §7).
