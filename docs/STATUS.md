...
> **갱신: 2026-07-12 (KST)** — **M1 뷰어 코어 완료 · `0.2.0` 태그.** M1-9 게이트 전 항목 통과:
> **100k 첫 렌더 115ms(<150) · 스크롤 2,098µs/프레임(60fps 예산의 13%) · B1 10k 유휴 RSS 27.87MB(≤30)**.
> 뷰어 축 원본 패리티 달성 — 가상 리스트·5컬럼 정렬·★교차 선택/러버밴드·키보드/타입어헤드·아이콘·네비게이션.
> 다음: **M2 셸 골격** — M2-1 경로 바 또는 M2-2 듀얼 패널/탭(P0)부터.
...
- **M2** 셸 골격 ☐ 다음 — 경로 바·듀얼 패널/탭·메뉴·테마·설정/세션·IME/UIA·상주 규율.
...
1. ~~M0~~ ✅ `0.1.0` · ~~M1~~ ✅ `0.2.0` (07-12) — 뷰어 코어 완료·게이트 통과.
2. **M2 착수**: M2-2 듀얼 패널+탭(P0·대) 또는 M2-1 경로 바(중) — 순차상 M2-1부터 권장.
