...
> 테스트 166 green·clippy 0·B2 **1.04MB**. 실기 QA(테스트 요청 목록 = journal) 대기.
> 다음: X-11 패리티 갭 건별 · X-2 Starlark · X-10 기본값 복원.
...
| B2 exe 크기 | ≤10MB | **1.04MB** (regex-lite 원장·X-3/X-10/갭 배치 반영) | 07-15 실기 |
