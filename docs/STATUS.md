...
3. **winget 0.17.0 PR 2건 심사 중**(08-23 제출 — **채널 제출 규칙 첫 적용**·우리 측 조치 불요·상태 추적만): [#422930](https://github.com/microsoft/winget-pkgs/pull/422930) Portable · [#422931](https://github.com/microsoft/winget-pkgs/pull/422931) 설치형. 카탈로그는 아직 두 채널 다 `0.16.0`(0.16.0 PR 2건은 08-11·08-14 병합 완료).
