...
| --- | --- | --- | --- | --- | --- | --- |
| `fix/navup-align` | 2026-07-15 | 2026-07-15 (main 병합) | 2026-07-15 | 1 | Alt+↑ 선택 위치 설정(상단/중단/하단 — select_program_aligned·nav_up_align 기본 중단)·**대소문자 구분 정렬**(SortSpec.case_sensitive·sort_case_sensitive 체크박스·전 탭 재정렬). 실기 노출·영속 검증 | [2026-07-15](journal/2026-07-15.md) |
