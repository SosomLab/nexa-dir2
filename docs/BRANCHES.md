...
| --- | --- | --- | --- | --- | --- | --- |
| `fix/prefs-batch2-qa` | 2026-07-15 | 2026-07-15 (main 병합) | 2026-07-15 | 1 | 배치 2 QA 5건 — 진행 창 중첩(erase)·공백 WM_CHAR 라우팅·파일 목록 그룹 분할+**본문 휠 스크롤**·**3×3 피커**(PosGrid)·리셋 ms 표시 누락(저장 리셋 진범) | [2026-07-15](journal/2026-07-15.md) |
