...
| --- | --- | --- | --- | --- | --- | --- |
| `fix/case-sort-group` | 2026-07-15 | 2026-07-15 (main 병합) | 2026-07-15 | 1 | 대소문자 정렬 **대문자 그룹 상단** 확정(사용자 스크린샷 QA — 코드포인트 순·Abc.txt<a c.txt. NTFS 순서 무관 확인). 테스트 167 green | [2026-07-15](journal/2026-07-15.md) |
