...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m2-panels` | 2026-07-12 | 2026-07-12 (`bddd5ef`) | — (CI green 후) | 3 | M2-2 — 듀얼 패널+패널별 탭: Panel 추출(탭=독립 뷰+히스토리)·TabBar·스플리터·활성 패널(Tab)·Ctrl+T/W/Ctrl+Tab. 테스트 90 green·실기 전 시나리오 확인·듀얼 RSS 25.1MB | [2026-07-12](journal/2026-07-12.md) |
