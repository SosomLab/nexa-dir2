...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/prefs-batch2` | 2026-07-15 | 2026-07-15 (main 병합) | 2026-07-15 | 1 | 설정 배치 2(사용자 요청 ①~③) — 전송 완료 2초 자동 닫기(PROG-WIN)·탭 더블클릭 동작(+**탭 고정** 신규: 📌·그룹 정렬·세션)·타입어헤드 옵션 전면(범위·리셋·HUD 3×3·체크 3). ④~⑥=X-12~14 등재. 168 green | [2026-07-15](journal/2026-07-15.md) |
