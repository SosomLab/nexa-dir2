...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m2-ui-feedback` | 2026-07-12 | 2026-07-12 (`da5272d`) | — (CI green 후) | 1 | 사용자 지시 — 네비 화살표 15 DIP 글리프·편집 모드 4변 테두리·M2-6 동적 i18n 설계 확정 | [2026-07-12](journal/2026-07-12.md) |
