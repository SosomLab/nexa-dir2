...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/transfer-progress-ux` | 2026-07-21 | —(실기 QA 후 병합 대기) | — | 1 | **X-30 전송 진행 UX 개편**(사용자 요청 5건) — "1 B" 오표기 수정(set_done 실제 바이트 유지)·설정 `transfer_close_secs`(0=창 미표시)·B~TB 단위+파일 수 표기·항목별 크기 비례 세그먼트 바(nexa-ops Event 프로토콜)·전송 중 대상 실행/드래그 잠금 | [2026-07-21](journal/2026-07-21.md) |
