...
- **검증**: `cargo test` **153 green**(신규 — 형제 펼침 유지[진입·복귀]+접힘 유지·세션 시드 restore·config panelN.expM 왕복[빈 목록 생략 인덱스 정렬]) · clippy 0 · fmt · B2 0.73MB · B3 무변 · 릴리스 빌드. **실기 QA 대기**: A000·B000 펼침 → B000 진입 → 복귀(양쪽 유지)·접기 후 왕복(접힘 유지)·재시작 후 펼침 복원(세션)·폴더 리네임 후 펼침 유지.
