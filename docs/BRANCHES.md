...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m2-persistence` | 2026-07-12 | 2026-07-12 (`e04e9d4`) | — (push·CI green 후) | 2 | M2-5 — 설정/세션 영속: exe 옆 `data\` key=value 텍스트(crate 0)·원자 쓰기·기동 로드/종료 저장. 실기 재실행 복원 검증·테스트 102 green | [2026-07-12](journal/2026-07-12.md) |
