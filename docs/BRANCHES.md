...
| --- | --- | --- | --- | --- | --- | --- |
| `feat/m2-resident` | 2026-07-12 | 2026-07-12 (`b848904`) | — | 3 | M2-8 — 상주 규율: 유휴 60s(자니터)·최소화 시 트림(DW 백버퍼+레이아웃 캐시·HICON 해제·작업집합 반납)·지연 재적재·유휴 백그라운드 0%. 실측 활성 26.9→트림 0.21~2.9MB 게이트 통과·테스트 105 green | [2026-07-12](journal/2026-07-12.md) |
...
- **생성**: 2026-07-12 (분기: main `de2adbb`). **커밋**: `f2b5d15`(트림·자니터·활동 추적) → `437c214`(docs 현행화) → `61c83a1`(권한 병합). 병합(`b848904`): 2026-07-12. 삭제: CI green 확인 후.
